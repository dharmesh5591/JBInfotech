...
/*
$("#f-icon").mouseenter(function(){
    $(".brand-letters").addClass("full-logo");
    
    
    setTimeout(function(){
        new Vivus('brand-icon', {
            type: 'delayed',
            duration: 100,
            animTimingFunction: Vivus.EASE_OUT
        });
...
$(".brand-letters").mouseleave(function(){
    $(".brand-letters").removeClass("full-logo");
});
